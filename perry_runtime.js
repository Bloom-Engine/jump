...
async function bootPerryWasm(wasmBase64, ffiImports) {
  ...
  globalThis.__perryClosureCall1 = (handleI64, argF64) => {
    ...
    const fn = instance.exports.__indirect_function_table?.get(c.funcIdx | 0);
    if (fn) fn(...c.captures, f64ToU64(argF64));
  };
...
const __asyncFuncImpls = {
  __async_loadSoundAsync: (__p0) => {
    ...
    return nanboxPointer(allocHandle(__p));
  },
...
// bloom_init_audio, bloom_close_audio, bloom_load_sound, bloom_play_sound, bloom_stop_sound, bloom_set_sound_volume, bloom_set_master_volume, bloom_load_music, bloom_play_music, bloom_stop_music, bloom_update_music_stream, bloom_set_music_volume, bloom_is_music_playing, bloom_play_sound_3d, bloom_set_listener_position, bloom_stage_sound, bloom_commit_sound, bloom_commit_music, bloom_init_window, bloom_close_window, bloom_window_should_close, bloom_begin_drawing, bloom_end_drawing, bloom_clear_background, bloom_set_target_fps, bloom_get_delta_time, bloom_get_fps, bloom_get_screen_width, bloom_get_screen_height, bloom_is_key_pressed, bloom_is_key_down, bloom_is_key_released, bloom_get_mouse_x, bloom_get_mouse_y, bloom_is_mouse_button_pressed, bloom_is_mouse_button_down, bloom_is_mouse_button_released, bloom_begin_mode_2d, bloom_end_mode_2d, bloom_begin_mode_3d, bloom_end_mode_3d, bloom_is_gamepad_available, bloom_get_gamepad_axis, bloom_is_gamepad_button_pressed, bloom_is_gamepad_button_down, bloom_is_gamepad_button_released, bloom_get_gamepad_axis_count, bloom_get_touch_x, bloom_get_touch_y, bloom_get_touch_count, bloom_inject_key_down, bloom_inject_key_up, bloom_inject_gamepad_axis, bloom_inject_gamepad_button_down, bloom_inject_gamepad_button_up, bloom_get_platform, bloom_is_any_input_pressed, bloom_toggle_fullscreen, bloom_set_window_title, bloom_get_time, bloom_set_window_icon, bloom_disable_cursor, bloom_enable_cursor, bloom_get_mouse_delta_x, bloom_get_mouse_delta_y, bloom_write_file, bloom_file_exists, bloom_read_file, bloom_run_game, bloom_draw_line, bloom_draw_rect, bloom_draw_rect_lines, bloom_draw_circle, bloom_draw_circle_lines, bloom_draw_triangle, bloom_draw_poly, bloom_draw_text, bloom_measure_text, bloom_load_font, bloom_draw_text_ex, bloom_measure_text_ex, bloom_unload_font, bloom_load_texture, bloom_unload_texture, bloom_draw_texture, bloom_draw_texture_rec, bloom_draw_texture_pro, bloom_get_texture_width, bloom_get_texture_height, bloom_load_image, bloom_image_resize, bloom_image_crop, bloom_image_flip_h, bloom_image_flip_v, bloom_load_texture_from_image, bloom_gen_texture_mipmaps, bloom_set_texture_filter, bloom_stage_texture, bloom_commit_texture
